...
@endif
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text"  readonly class="form-control" name="autor" id="formGroupExampleInput" placeholder="Autor"value="{{$blog->autor}}" >
      </div>
    ...
    <div class="form-group">
      ...
      <input class="form-control" readonly id="exampleFormControlTextarea1" rows="3"  name="categoria" value="{{$blog->categoria}}"></input>
    </div>
