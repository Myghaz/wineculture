        ...
        <input type="hidden" name="id" value="{{$value->id}}">
            ...
            <div style="display: none;" id="text{{$value->id}}">
                ...
                <div class="autor" id="autor">
                    <img src="http://wineculture.test/wp-content/uploads/2020/10/banner5.jpg" /><span class="nome">Nome</span><span>Apelido</span>
                </div>
            </div>
            <div class="texto">
                <h2 id="texto_titulo" class="info">{{$value->titulo}}<span class="categoria">{{$value->id_categoria}}</span></h2>
