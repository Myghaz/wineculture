    ...
    <div class="hero-container">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <!-- Slide 1 -->
                <div class="carousel-item active" style="background-image: url('/assets/img/paginas/frontend/index/slide/slide-1.jpg');">
                ...
                <!-- Slide 2 -->
                <div class="carousel-item" style="background-image: url('/assets/img/paginas/frontend/index/slide/slide-2.jpg');">
                    <div class="carousel-container">
                        <div class="carousel-content container">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" style="background-image: url('/assets/img/paginas/frontend/index/slide/slide-3.jpg');">
                    <div class="carousel-container">
                        <div class="carousel-content container">
...
<main id="main">
    ...
    <section id="team" class="team">
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 " data-aos="fade-up">
                    <div class="member">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 " data-aos="fade-up" data-aos-delay="100 ">
                    <div class="member ">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 " data-aos="fade-up " data-aos-delay="200 ">
                    <div class="member ">
                        <div class="pic ">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 " data-aos="fade-up " data-aos-delay="300 ">
                    <div class="member ">
